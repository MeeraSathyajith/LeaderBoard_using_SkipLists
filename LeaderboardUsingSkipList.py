...
class Player:
    def __init__(self, name, score, level, tieBreaker):
        self.name = name
        self.score = score
        self.level = level
    ...
    def __repr__(self):
        return f"Player({self.name!r}, {self.score}, tieBreaker = {self.tieBreaker})"
...
if __name__ == "__main__":
    ...
    lb.loadFromCSV(r"c:\Users\Meera\OneDrive\Documents\SEM 3\DSA\DSA_final\players250000.csv")
